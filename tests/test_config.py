...
def test_load_config_valid(tmp_project, monkeypatch):
    ...
    monkeypatch.setattr("chess_opening_prep.config._find_project_root", lambda: tmp_project)
    config = load_config()
...
def test_load_config_missing(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("chess_opening_prep.config._find_project_root", lambda: tmp_path)
